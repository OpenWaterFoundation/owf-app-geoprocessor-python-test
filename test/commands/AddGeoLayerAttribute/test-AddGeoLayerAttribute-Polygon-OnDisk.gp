StartLog(LogFile="results/test-AddGeoLayerAttribute-Polygon-On-Disk.gp.log")
...
RemoveFile(SourceFile="results/test-AddGeoLayerAttribute-Polygon-On-Disk-out.geojson",IfSourceFileNotFound="Ignore")
...
# WriteGeoLayerToGeoJSON(GeoLayerID="polygon_copy",OutputFile="expected-results/test-AddGeoLayerAttribute-Polygon-On-Disk-out.geojson")
# Write the in-memory polygon Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="polygon_copy",OutputFile="results/test-AddGeoLayerAttribute-Polygon-On-Disk-out.geojson")
# Compare the results to the expected results
CompareFiles(InputFile1="expected-results/test-AddGeoLayerAttribute-Polygon-On-Disk-out.geojson",InputFile2="results/test-AddGeoLayerAttribute-Polygon-On-Disk-out.geojson",IfDifferent="Warn")