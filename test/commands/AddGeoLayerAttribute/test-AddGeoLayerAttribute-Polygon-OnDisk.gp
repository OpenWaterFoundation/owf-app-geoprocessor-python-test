...
#WriteGeoLayerToGeoJSON(GeoLayerID="polygon_copy",OutputFile="expected-results/test-AddGeoLayerAttribute-Polygon-On-Disk-out")
# Write the in-memory polygon Geolayer to a GeoJSON file 
WriteGeoLayerToGeoJSON(GeoLayerID="polygon_copy",OutputFile="results/test-AddGeoLayerAttribute-Polygon-On-Disk-out")
