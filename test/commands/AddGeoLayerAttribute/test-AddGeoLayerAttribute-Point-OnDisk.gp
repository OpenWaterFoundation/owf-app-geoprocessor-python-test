...
RemoveFile(SourceFile="results/test-AddGeoLayerAttribute-Point-OnDisk-out.geojson", IfSourceFileNotFound="Ignore")
...
WriteGeoLayerToGeoJSON(GeoLayerID="point", OutputFile="expected-results/test-AddGeoLayerAttribute-Point-OnDisk-out")
# Write the point Geolayer to a GeoJSON file 
WriteGeoLayerToGeoJSON(GeoLayerID="point", OutputFile="results/test-AddGeoLayerAttribute-Point-OnDisk-out")
# Compare the results to the expected results
CompareFiles(InputFile1="expected-results/test-AddGeoLayerAttribute-Point-OnDisk-out.geojson", InputFile2="results/test-AddGeoLayerAttribute-Point-OnDisk-out.geojson",IfDifferent="Warn")
