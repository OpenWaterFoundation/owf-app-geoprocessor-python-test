...
WriteGeoLayerToGeoJSON(GeoLayerID="points_copy",OutputFile="expected-results/test-CopyGeoLayer-Points-IncludeFeaturesIf-out.geojson")
# Write the copied Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="points_copy",OutputFile="results/test-CopyGeoLayer-Points-IncludeFeaturesIf-out.geojson")
