...
WebGet(FileURL = "https://github.com/OpenWaterFoundation/owf-app-geoprocessor-python-test/blob/master/test/commands/WebGet/data/line_shp.zip?raw=true", OutputFile = "expected-results/test-WebGet-DownloadableZipFile-UnzipAndRemove", IfZipFile="UnzipAndRemove")
# Get the downloadable file from the web
WebGet(FileURL = "https://github.com/OpenWaterFoundation/owf-app-geoprocessor-python-test/blob/master/test/commands/WebGet/data/line_shp.zip?raw=true", OutputFile = "results/test-WebGet-DownloadableZipFile-UnzipAndRemove", IfZipFile="UnzipAndRemove")
