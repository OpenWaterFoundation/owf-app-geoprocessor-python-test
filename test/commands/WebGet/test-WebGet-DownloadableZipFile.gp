...
# - currently disabled because a SSL connection error occurs when downloading a zip file from GitHub.
#   Downloading a zip file from other sites work (example GeoMAC fire data).
#@enabled false
#
#
...
WebGet(URL="https://github.com/OpenWaterFoundation/owf-app-geoprocessor-python-test/tree/main/test/commands/WebGet/data/line_shp.zip?raw=true",OutputFile="results/test-WebGet-DownloadableZipFile")
