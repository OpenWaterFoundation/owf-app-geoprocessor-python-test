...
WebGet(FileURL = "https://github.com/OpenWaterFoundation/owf-app-geoprocessor-python-test/blob/master/test/commands/WebGet/data/line_shp.zip?raw=true", OutputFile = "results/test-WebGet-DownloadableZipFile")
