...
CompareFiles(InputFile1="expected-results/test-WriteGeoLayerToShapefile-Line-OutputCRS-out.dbf", InputFile2="results/test-WriteGeoLayerToShapefile-Line-OutputCRS-out.dbf",IfDifferent="Warn")
