...
|`point.txt`|An empty text (`.txt`) file.|Manually created Windows operating system.|See step-by-step instructions below.|
...
|2|Navigate to inside the folder where the text file will live.|
|3|Right-click in the main screen of the folder.|
|4|Click `New` > `Text Document`.|
|5|The `.txt` file will appear in the main screen of the folder.|
|6|Enter a name for the text file.|
