...
CopyFile(SourceFile="data/line.geojson", DestinationFile="expected-results/test-ReadGeoLayerFromGeoJSON-Line-AllowedDiffCount2-out.geojson")
...
CompareFiles(InputFile1="expected-results/test-ReadGeoLayerFromGeoJSON-Line-AllowedDiffCount2-out.geojson", InputFile2="results/test-ReadGeoLayerFromGeoJSON-Line-AllowedDiffCount2-out.geojson",AllowedDiffCount="2",IfDifferent="Warn")