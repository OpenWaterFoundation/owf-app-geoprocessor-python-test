...
WriteTableToDelimitedFile(TableID="testTable", OutputFile="results/test-ReadTableFromDelimitedFile-csv-out.csv")
# Compare the results to the input file. 
CompareFiles(InputFile1="results/test-ReadTableFromDelimitedFile-csv-out.csv", InputFile2="data/table-textfile-comma.csv", IfDifferent="Warn")