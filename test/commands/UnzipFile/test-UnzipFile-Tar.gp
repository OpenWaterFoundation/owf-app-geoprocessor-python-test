...
#UnzipFile(File="results/test-UnzipFile-Tar-in.tar", FileType="tar", OutputFolder="expected-results")
...
UnzipFile(File="results/test-UnzipFile-Tar-in.tar", FileType="tar", DeleteFile="True")
