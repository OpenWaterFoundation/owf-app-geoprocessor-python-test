...
# WriteGeoLayerToGeoJSON(GeoLayerID="SummitCounty_simple_1000",OutputFile="expected-results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance1000-out.geojson")
# Write the copied Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="SummitCounty_simple_1000",OutputFile="results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance1000-out.geojson")
