...
SimplifyGeoLayerGeometry(GeoLayerID = "SummitCounty_copy", Tolerance="1000")
# Uncomment the line below to recreate the expected results
#WriteGeoLayerToGeoJSON(GeoLayerID="SummitCounty_copy", OutputFile="expected-results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance1000-out")
# Write the copied Geolayer to a GeoJSON file 
WriteGeoLayerToGeoJSON(GeoLayerID="SummitCounty_copy", OutputFile="results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance1000-out")
