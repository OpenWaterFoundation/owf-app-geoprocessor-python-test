...
# WriteGeoLayerToGeoJSON(GeoLayerID="Summit_simple100",OutputFile="expected-results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance100-out.geojson")
# Write the copied Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="Summit_simple100",OutputFile="results/test-SimplifyGeoLayerGeometry-Polygon-Tolerance100-out.geojson")
