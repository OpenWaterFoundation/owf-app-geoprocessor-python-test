...
# WriteGeoLayerToGeoJSON(GeoLayerID="Simple_50",OutputFile="expected-results/test-SimplifyGeoLayerGeometry-Line-Tolerance50-out.geojson")
# Write the copied Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="Simple_50",OutputFile="results/test-SimplifyGeoLayerGeometry-Line-Tolerance50-out.geojson")
