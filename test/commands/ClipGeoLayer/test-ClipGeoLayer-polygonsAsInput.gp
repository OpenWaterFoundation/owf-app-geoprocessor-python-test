...
ReadGeoLayerFromGeoJSON(SpatialDataFile="data/input_polygons.geojson")
...
#WriteGeoLayerToGeoJSON(GeoLayerID="input_polygons_clippedBy_clipping_polygon", OutputFile="expected-results/test-ClipGeoLayer-polygonsAsInput-out")
# Write the polygon, polygon and polygon Geolayers to a GeoJSON file 
WriteGeoLayerToGeoJSON(GeoLayerID="input_polygons_clippedBy_clipping_polygon", OutputFile="results/test-ClipGeoLayer-polygonsAsInput-out")
