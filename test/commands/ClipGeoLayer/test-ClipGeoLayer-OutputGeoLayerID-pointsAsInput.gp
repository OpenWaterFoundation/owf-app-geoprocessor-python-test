...
ReadGeoLayerFromGeoJSON(SpatialDataFile="data/input_points.geojson")
...
#WriteGeoLayerToGeoJSON(GeoLayerID="test", OutputFile="expected-results/test-ClipGeoLayer-OutputGeoLayerID-pointsAsInput-out")
# Write the point to a GeoJSON file 
WriteGeoLayerToGeoJSON(GeoLayerID="test", OutputFile="results/test-ClipGeoLayer-OutputGeoLayerID-pointsAsInput-out")
