...
# WriteGeoLayerToGeoJSON(GeoLayerID="output",OutputFile="expected-results/test-ClipGeoLayer-linesAsInput-Memory-out.geojson")
# Write the line and polygon Geolayers to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="output",OutputFile="results/test-ClipGeoLayer-linesAsInput-Memory-out.geojson")
