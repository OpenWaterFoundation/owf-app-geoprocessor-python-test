...
ReadGeoLayerFromGeoJSON(SpatialDataFile="data/input_lines.geojson", GeoLayerID = "Lines")
ReadGeoLayerFromGeoJSON(SpatialDataFile="data/clipping_polygon.geojson", GeoLayerID = "Polygon")
