...
# WriteGeoLayerToGeoJSON(GeoLayerID="points",OutputFile="expected-results/test-ReadGeoLayerFromDelimitedFile-Points-out.geojson")
# Write the line Geolayer to a GeoJSON file
WriteGeoLayerToGeoJSON(GeoLayerID="points",OutputFile="results/test-ReadGeoLayerFromDelimitedFile-Points-out.geojson")
