...
# WriteGeoLayerToGeoJSON(GeoLayerID="input_points_intersectedBy_intersect_lines",OutputFile="expected-results/test-IntersectGeoLayer-points-linesAsIntersect-out.geojson")
# Write the output intersected line GeoLayer to GeoJSON format.
WriteGeoLayerToGeoJSON(GeoLayerID="input_points_intersectedBy_intersect_lines",OutputFile="results/test-IntersectGeoLayer-points-linesAsIntersect-out.geojson")
