...
# WriteGeoLayerToGeoJSON(GeoLayerID="input_lines_intersectedBy_intersect_polygons",OutputFile="expected-results/test-IntersectGeoLayer-lines-polygonAsIntersect-out.geojson")
# Write the output intersected line GeoLayer to GeoJSON format.
WriteGeoLayerToGeoJSON(GeoLayerID="input_lines_intersectedBy_intersect_polygons",OutputFile="results/test-IntersectGeoLayer-lines-polygonAsIntersect-out.geojson")
