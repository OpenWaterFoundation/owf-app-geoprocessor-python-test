...
rem %GP% --commands ../../commands/Blank/test-Blank.gp
rem %GP% --commands ../../commands/Comment/test-Comment.gp
...
rem %GP% --commands ../../commands/WritePropertiesToFile/test-WritePropertiesToFile-IncludeProperties-NameTypeValuePython-Ascending.gp
