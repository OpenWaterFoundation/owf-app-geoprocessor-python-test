...
echo See create-test-command-file-dev.bat.log for window output (adds a bit more information).
echo.
...
echo See create-regression-test-command-file-dev.bat.log for output from running command file.
echo.
